...
const DocumentItem: React.FC<DocumentItemProps> = ({
  ...
  const content = (
    <div className="flex items-start space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200 mb-12">
      {/* PDF Icon */}
